    ...
    <div className="flex rounded-xl lg:flex-row flex-col drop-shadow-md bg-[#f2fdf9] my-7 mb-9 h-full lg:h-[42vh]">
      <div className="flex flex-col lg:pl-16 flex-1 ">
        ...
        <div className="flex xl:w-[80%] justify-center lg:pl-0 w-full items-center lg:justify-between  flex-1">
          <button className="flex border-2 h-[5vh] w-[25%] lg:w-[50%] xl:w-[60%] rounded-lg font-semibold text-sm lg:text-md justify-center items-center border-green-500 mr-3 hover:bg-green-600 hover:text-white">
            Get Started
          </button>
          <button className="flex border-2 h-[5vh] w-[25%] lg:w-[50%] xl:w-[60%] rounded-lg font-semibold text-sm lg:text-md justify-center items-center border-green-500 mx-3  hover:bg-green-600 hover:text-white">
            Explore Menu
          </button>
        </div>
      </div>
